...
type Screen struct {
	...
	SizeInch   float32            `protobuf:"fixed32,1,opt,name=size_inch,json=sizeInch,proto3" json:"size_inch,omitempty"`              // 屏幕尺寸
	Resolution *Screen_Resolution `protobuf:"bytes,2,opt,name=resolution,proto3" json:"resolution,omitempty"`                            // 分辨率
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=techschool.pcbook.Screen_Panel" json:"panel,omitempty"` // 面板类型
	Multitouch bool               `protobuf:"varint,4,opt,name=multitouch,proto3" json:"multitouch,omitempty"`                           // 多点触碰
}
